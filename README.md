...
Вы можете выполнить проверку телефонных номеров списком или по одному,
определяя доступных и недоступных абонентов и осуществить последующую чистку базы данных от неактуальных номеров.
